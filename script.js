...
function botaoMudarTela(){
    ...
    document.getElementById("celular01").src = "img/fotoCelular2.png";
    document.getElementById("celular01").style.width= "700px";
    document.getElementById("celular01").style.height= "700px";
    document.getElementById("celular01").style.marginTop= "15%";
        ...
        document.getElementById("celular01").src = "img/Pagina1.png" ;
